...
| --- | --- | --- |
| `reproducible_plot` | Equivalent data figure can be generated from committed processed data and repository scripts | `(111)` AHC, `(103)` AHC, rank-cumulative AHC, strain AHC |
...
| `workflow_required` | Compact data extraction still requires generated large Hamiltonian, HDF5, Wannier, or AHC intermediate files | band convergence, multipole coefficients, single-rank AHC, minimal-model scans |
