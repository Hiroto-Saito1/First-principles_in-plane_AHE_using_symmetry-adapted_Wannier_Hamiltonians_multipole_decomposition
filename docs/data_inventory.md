...
| `data/source/` | included | Small committed source snapshots and fallback provenance metadata used to rebuild `data/processed/` without running the full HPC workflow. |
