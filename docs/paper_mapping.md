...
convergence composite are recorded in the inventory but are not tracked as
figure PDFs. Compact source snapshots, CSV/JSON data, and plotting scripts
have been added for the primary AHC, rank-resolved, strain,
multipole-coefficient, and minimal-model figures. The complete
...
| Band/bond convergence figure | `scripts/workflow/generate_large_files.md` | inventory checks | `workflow_required` |
