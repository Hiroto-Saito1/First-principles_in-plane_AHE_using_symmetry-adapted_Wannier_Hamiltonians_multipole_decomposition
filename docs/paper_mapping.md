...
repository scripts. Repository-local reproduction scripts generate
manuscript-style figures under `results/figures_paper/` and may also emit
diagnostic comparison plots under `results/figures_diagnostics/`. Static manuscript schematics,
