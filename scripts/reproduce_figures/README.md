...
The AHC angular-dependence scripts also support a diagnostic mode that writes
to `results/figures_diagnostics/` and keeps internal comparison series such as
`Wan90`, `SW+ED`, `SW+PD`, and `cubic fit` separate from manuscript-facing
labels.
