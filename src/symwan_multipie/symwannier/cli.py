...
import argparse
import sys
from . import expand_wannier_inputs, wannierize
...
def main():
    ...
    expand_parser = subparsers.add_parser(
        "expand", help="Expand input files using symmetry information", add_help=False
    )

    wannier_parser = subparsers.add_parser(
        "wannierize",
        help="Perform Wannierization using symmetry inputs",
        add_help=False,
    )
